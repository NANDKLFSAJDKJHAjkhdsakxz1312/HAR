...
data_folder = r"D:\HAR\HAPT_Data_Set\RawData"
...
window_size = 250  # 窗口大小（5秒）
window_step = 125  # 窗口移动步长（50%重叠）
...
for dataset_name, dataset in tensor_datasets.items():
    with tf.io.TFRecordWriter(f'{dataset_name}.tfrecords') as writer:
